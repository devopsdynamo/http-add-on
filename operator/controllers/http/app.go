...
func (r *HTTPScaledObjectReconciler) createOrUpdateApplicationResources(
	...
	// reconciler will skip the KEDA core ScaledObjects creation. If the scaledObject has already been
	// created it will delete scaledObject, so you can create your own and add http scaler as one of your triggers.
